/**
 * Picked from adapter-node
 *
 * Because adapter-node doesn't expose rollup's external dependencies
 * it is not possible to avoid @libsql/client bundled in if it is
		...
		async adapt(builder) {
			...
			const bundle = await rollup({
				...
				external: [
					...
					// Avoiding any @libsql libraries getting bundled in
					/^@libsql\/.*/
				],
				plugins: [
					nodeResolve({
